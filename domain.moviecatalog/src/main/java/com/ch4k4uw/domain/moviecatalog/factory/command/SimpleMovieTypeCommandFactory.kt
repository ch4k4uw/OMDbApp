...
class SimpleMovieTypeCommandFactory @Inject constructor(private val repository: MovieTypeQueryRepository, private val specFactory: MovieTypeQueryRepositoryListSpecificationFactory): MovieTypeCommandFactory {
